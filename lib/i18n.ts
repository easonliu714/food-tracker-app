...
export const TRANSLATIONS = {
  'zh-TW': {
    ...
    // General
    welcome: "歡迎", save: "儲存", cancel: "取消", error: "錯誤", success: "成功", loading: "載入中...",
    ...
    // Analysis
    trend_analysis: "數據分析",
    chart_title_cal: "熱量收支趨勢", // [新增]
    chart_title_body: "體重與體脂趨勢", // [新增]
    week: "近7天", month: "近30天", avg_daily: "日均數值",
    
    // Activity Editor [新增]
    record_activity: "紀錄運動",
    select_activity: "選擇運動",
    custom_activity: "自訂運動",
    input_activity_name: "輸入運動名稱",
    activity_intensity: "運動強度",
    activity_details: "詳細數據",
    time_min: "時間 (分鐘)",
    distance_km: "距離 (km)",
    steps: "步數",
    floors: "樓層",
    est_calories: "預估消耗熱量",
    feeling_notes: "運動感受 & 筆記",
    enter_notes: "輸入筆記...",
    data_incomplete: "資料不完整",
    data_incomplete_msg: "請選擇運動項目，並至少輸入一項數據",
    
    // Activity Categories & Items [新增]
    ...
    // Profile & AI
    ai_settings: "AI 設定", basic_info: "基本資料", gender: "性別", male: "男", female: "女", height: "身高", weight: "體重", body_fat: "體脂率",
    training_goal: "訓練目標", activity_level: "日常活動量", save_settings: "儲存設定",
    api_key_placeholder: "貼上您的 API Key", test_key: "測試 Key", current_model: "當前模型", language: "語言",
    ...
    ai_coach: "AI 教練", ai_hello: "嗨! 我是你的營養訓練員.", remaining_budget: "今日剩餘熱量", generate_plan: "生成計畫",
    ...
    // Food Editor
    ai_analysis: "AI 分析", composition: "食物組成", suggestion: "攝取建議",
  ...
  'en': {
    ...
    welcome: "Welcome", save: "Save", cancel: "Cancel", error: "Error", success: "Success", loading: "Loading...",
    ...
    input_activity_name: "Enter Activity Name",
    ...
    feeling_notes: "Notes & Feeling",
    enter_notes: "Enter notes...",
    data_incomplete: "Incomplete Data",
    data_incomplete_msg: "Please select activity and enter at least one value.",
    ...
    ai_settings: "AI Settings", basic_info: "Basic Info", gender: "Gender", male: "Male", female: "Female", height: "Height", weight: "Weight", body_fat: "Body Fat",
    training_goal: "Goal", activity_level: "Activity Level", save_settings: "Save Settings",
    api_key_placeholder: "Paste API Key", test_key: "Test Key", current_model: "Model", language: "Language",
    ...
    ai_analysis: "AI Analysis", composition: "Composition", suggestion: "Suggestion",
