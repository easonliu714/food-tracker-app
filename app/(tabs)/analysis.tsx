  ...
  return (
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <ScrollView ref={scrollViewRef} contentContainerStyle={{padding: 16}} scrollEnabled={true}>
        ...
        <TutorialTarget targetKey="analysis_period" onMeasure={(y) => targetPositions.current['analysis_period'] = y} adjustment={{offsetY: 20}}>
        ...
        <TutorialTarget targetKey="analysis_range" onMeasure={(y) => targetPositions.current['analysis_range'] = y} adjustment={{offsetY: 10}}>
        ...
        <TutorialTarget targetKey="analysis_grid" onMeasure={(y) => targetPositions.current['analysis_grid'] = y} adjustment={{offsetY: -50}}>
